  ...
  const handleCopyToClipboard = () => {
    ...
    return(
        ...
        <div className='w-2/6 mx-auto mt-5 text-black'>
            ...
            <p className='text-purple-200 text-sm'>Your link will only be valid for 30 days. Want own your links and view their analytics? <a href="https://app.gumly.co" className="underline">Create a free acount.</a></p>
          </div>
